...
export default function HeroSection() {
  return (
    <section className="relative flex-1 min-h-0 w-full overflow-hidden bg-[#E9E8E4]">
      <div className="pointer-events-none absolute inset-y-0 right-0 w-full lg:w-[65vw] hero-image-animate">
      ...
      <Container className="relative z-10 flex min-h-full items-stretch">
        <div className="h-full w-full pt-16 pb-24 lg:pt-20 lg:pb-24 lg:w-[35vw] bg-[#E9E8E4]">
          <div className="flex h-full flex-col justify-between gap-6 p-8 lg:p-11">
            <div>
              <span className="hero-label-animate text-xs uppercase tracking-[0.25em] text-[#7F7F7F]/80">Stamford Security</span>
              <h1 className="hero-heading-animate max-w-2xl text-5xl font-medium leading-[1.05] text-[#0E151D] sm:text-5xl">
                Security for
                <br />
                what matters <span className="text-[#7F7F7F]">most.</span>
              </h1>
              <div className="hero-copy-animate h-0.5 w-24 bg-[#0E151D]/95 mt-6" />
              <p className="hero-copy-animate max-w-lg text-[28px] leading-9 text-[#7F7F7F] mt-6">
                Professional security solutions for businesses and properties.
              </p>
            </div>
            <div className="flex flex-wrap items-center gap-4 hero-actions-animate">
